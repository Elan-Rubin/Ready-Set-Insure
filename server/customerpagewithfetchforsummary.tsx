// this is just to keep track of the old one 
// since elan updated the page.tsx file for 
// customer-dashboard and i want to keep the fetch 
// function here for copy paste
